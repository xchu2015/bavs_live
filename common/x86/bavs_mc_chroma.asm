;*****************************************************************************
;* bavs_mc_chroma.asm: cavs decoder library
;*****************************************************************************
...
;------------------------------------------------------------------------------
cglobal %1_%2_chroma_mc8%3_mmxext, 6, 7; + extra_regs, 0
%if ARCH_X86_64==1
    movsxd        r2, r2d
	movsxd        r4, r4d
	movsxd        r5, r5d
...
;------------------------------------------------------------------------------
; put/avg_h264_chroma_mc4_*(uint8_t *dst /*align 8*/, uint8_t *src /*align 1*/,
;                           int stride, int h, int mx, int my)
;------------------------------------------------------------------------------
cglobal %1_%2_chroma_mc4_mmxext, 6, 6; + extra_regs, 0
%if ARCH_X86_64==1
    movsxd        r2, r2d
	movsxd        r4, r4d
	movsxd        r5, r5d
...
;------------------------------------------------------------------------------
; put/avg_h264_chroma_mc2_*(uint8_t *dst /*align 8*/, uint8_t *src /*align 1*/,
;                           int stride, int h, int mx, int my)
;------------------------------------------------------------------------------
%macro chroma_mc2_mmx_func 2
cglobal %1_%2_chroma_mc2_mmxext, 6, 7;, 0
%if ARCH_X86_64==1
    movsxd        r2, r2d
	movsxd        r4, r4d
	movsxd        r5, r5d
...
cglobal %1_%2_chroma_mc8%3_ssse3, 6, 7;, 8
%if ARCH_X86_64==1
    movsxd        r2, r2d
	movsxd        r4, r4d
	movsxd        r5, r5d
...
cglobal %1_%2_chroma_mc4_ssse3, 6, 7;, 0
%if ARCH_X86_64==1
    movsxd        r2, r2d
	movsxd        r4, r4d
	movsxd        r5, r5d
...
.next2rows:
    ...
    ;movd          m3, [r1+r2*2]
    movd          m3, [r1+r2+r2]
    punpcklbw     m1, [r1+r2+1]
    ;punpcklbw     m3, [r1+r2*2+1]
    ;lea           r1, [r1+r2*2]
    punpcklbw     m3, [r1+r2+r2+1]
    lea           r1, [r1+r2+r2]
